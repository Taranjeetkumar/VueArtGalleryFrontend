    ...
    <div class="fixed top-4 right-4 z-50 flex flex-col gap-2 max-w-md">
      <TransitionGroup name="toast">
        <div
          ...
          :key="toast.id"
          :class="[
            'px-6 py-4 rounded-lg shadow-2xl border flex items-start gap-3 min-w-[300px] backdrop-blur-sm',
        ...
        >
          ...
          <div class="flex-1">
            ...
            <p v-if="toast.description" class="text-xs mt-1 opacity-90">{{ toast.description }}</p>
          </div>
